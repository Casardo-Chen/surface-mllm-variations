    ...
    <Card 
      ...
      >
        ...
        {/* <div className="level-buttons">
          ...
          style={{
            marginRight: "8px",
            backgroundColor: mode === "response" ? "#999999" : "#ffffff",
            color: mode === "response" ? "#ffffff" : "#000000",
          }}  
          onClick={() => setMode("response")}>Response</button>
          <button 
          style={{
            marginRight: "8px",
            backgroundColor: mode === "sentence" ? "#999999" : "#ffffff",
            color: mode === "sentence" ? "#ffffff" : "#000000",
          }}
          onClick={() => setMode("sentence")}>Sentence</button>
            <button
          style={{
            backgroundColor: mode === "atomic" ? "#999999" : "#ffffff",
            color: mode === "atomic" ? "#ffffff" : "#000000",
          }}
          onClick={() => setMode("atomic")}>Atomic Facts</button>
        </div> */}
