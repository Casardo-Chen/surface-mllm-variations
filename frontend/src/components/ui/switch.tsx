...
const switchVariants = cva(
  `
    ...
    [aria-invalid="true"]:border [aria-invalid="true"]:border-destructive/60 [aria-invalid="true"]:ring-destructive/10 dark:[aria-invalid="true"]:border-destructive dark:[aria-invalid="true"]:ring-destructive/20
